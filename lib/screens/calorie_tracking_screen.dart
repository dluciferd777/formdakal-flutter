...
class CalorieTrackingScreen extends StatelessWidget {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Bazal Metabolizma Hızı (BMR) Kartı
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.balance, color: AppColors.primaryGreen, size: 24), // İkon boyutu
            ...
            Align(
              ...
              child: Text(
                ...
                style: Theme.of(context).textTheme.displaySmall?.copyWith(
                  color: isDeficit ? AppColors.primaryGreen : AppColors.calorieColor, // Renk değişimi
            ...
            const Divider(height: 24), // Divider yüksekliği azaltıldı
            Text('Günlük Kalori Özeti', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: isDarkMode ? Colors.white : Colors.black, fontSize: 16)), // Yazı boyutu
            const SizedBox(height: 8), // Boşluk azaltıldı
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                _buildCalorieStatItem(context, 'Hedef', remaining + consumed - burned, AppColors.primaryGreen), // Hedefi doğru hesapla
            ...
            const SizedBox(height: 8), // Boşluk azaltıldı
            Text('BMR: ${consumed.toInt()} kal | TDEE: ${burned.toInt()} kal', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: isDarkMode ? Colors.white70 : Colors.black54)), // BMR ve TDEE bilgileri
          ],
        ),
      ),
    );
  ...
  // Yeni Makro Besin Dağılımı Kartı
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.pie_chart, color: AppColors.primaryGreen, size: 24), // İkon boyutu
                const SizedBox(width: 8),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.water_drop, color: AppColors.timeColor, size: 24), // İkon boyutu
                const SizedBox(width: 8),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.track_changes, color: AppColors.primaryGreen, size: 24), // İkon boyutu
                const SizedBox(width: 8),
  ...
  // Yeni Bazal Metabolizma Hızı (BMR) Kartı
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.access_time, color: AppColors.timeColor, size: 24), // İkon boyutu
                const SizedBox(width: 8),
            ...
            Row(
              children: [
                Icon(Icons.trending_up, color: AppColors.primaryGreen, size: 24), // İkon boyutu
                const SizedBox(width: 8),
  ...
  // Yardımcı widget'lar
  Widget _buildCalorieStatItem(BuildContext context, String title, double value, Color color) { // BuildContext eklendi
    return Column(
      children: [
        Text(title, style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500, fontSize: 13)), // Yazı boyutu küçültüldü
        const SizedBox(height: 4),
        Text('${value.toInt()} kal', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: color, fontWeight: FontWeight.bold, fontSize: 16)), // Yazı boyutu küçültüldü
      ],
    );
  }

  Widget _buildMacroRow(BuildContext context, String label, String value, Color color) { // BuildContext eklendi
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 4.0), // Dikey padding azaltıldı
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(label, style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontSize: 14)), // Yazı boyutu küçültüldü
          Text(value, style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold, color: color, fontSize: 14)), // Yazı boyutu küçültüldü
        ],
      ),
    );
  }
