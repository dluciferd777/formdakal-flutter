// lib/widgets/step_counter_card.dart - KENAR ÇİZGİSİ KALDIRILDI GÖLGE EKLENDİ
...
class StepCounterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: AppTheme.cardDecoration(context), // YENİ: Tema'dan gölge, kenar çizgisi yok
      child: InkWell(
        onTap: () {
          Navigator.pushNamed(context, '/step_details');
        },
        borderRadius: BorderRadius.circular(16), // YENİ: Tıklama efekti için
        child: Padding(
          padding: const EdgeInsets.all(16.0), // YENİ: Padding artırıldı
